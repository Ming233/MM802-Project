...
import { getHrpredictions } from './api';
...
const HRpredictionPage: React.FC = () => {
  ...
  const loadData = useCallback(async () => {
    const prices = await getHrpredictions();
...
export default HRpredictionPage;
